...
def setup(screen, eyesy):
    ...
    audio_history = [[0] * 10 for _ in range(63)]
    ...
    for row in range(grid_height):
        for col in range(grid_width):
            ...
            if eyesy.knob1 < 0.15:
                ...
                pygame.draw.aalines(screen, color, False, additional_line)
                ...
                pygame.draw.aalines(screen, color, False, additional_line)
                pygame.draw.aalines(screen, color, False, additional_line2)
                ...
                pygame.draw.aalines(screen, color, False, additional_line)
                pygame.draw.aalines(screen, color, False, additional_line3)
                ...
                pygame.draw.aalines(screen, color, False, additional_line2)
                pygame.draw.aalines(screen, color, False, additional_line3)
                pygame.draw.aalines(screen, color, False, additional_line4)
   #Trails
