...
def draw(screen, eyesy) :
    global  x1_nudge, y1_nudge, x2_nudge, y2_nudge, x3_nudge, y3_nudge, x4_nudge, y4_nudge, trigger, x1, y1, x2, y2, x3, y3, x4, y4, xr, yr, xhalf, yhalf
    eyesy.color_picker_bg(eyesy.knob5)
    rad50 = xr * 0.078#((50*xr)/1280)
    speed60 = xr * 0.047#((60*xr)/1280)
    ...
    x_speed = (speed60*eyesy.knob1)-(speed60/2) #horizontal speed on knob1
    y_speed = (speed60*eyesy.knob2)-(speed60/2) #vertical speed on knob2
    ...
    for i in range(0, 3) :
        for j in range(0, 5) :
            ...
            restRad = int(rad50*eyesy.knob3)+2
            color = eyesy.color_picker_lfo(eyesy.knob4, 200)
            if (i%2) == 1 :
                x1 = j*(xr/5)+(xr/10)+int(x1_nudge)
            if (j%2) == 1 :
                y1 = i*(yr/3)+(yr/6)+int(y1_nudge)
    ...
    for i in range(0, 3) :
        for j in range(0, 5) :
            ...
            restRad = int(rad50*eyesy.knob3)+2
            color = eyesy.color_picker_lfo(eyesy.knob4, 150)
            if (i%2) == 1 :
                x2 = j*(xr/5)+(xr/10)+int(x2_nudge)
            if (j%2) == 1 :
                y2 = i*(yr/3)+(yr/6)+int(y2_nudge)
    ...
    for i in range(0, 3) :
        for j in range(0, 5) :
            ...
            restRad = int(rad50*eyesy.knob3)+2
            color = eyesy.color_picker_lfo(eyesy.knob4, 100)
            if (i%2) == 1 :
                x3 = j*(xr/5)+(xr/10)+int(x3_nudge)
            if (j%2) == 1 :
                y3 = i*(yr/3)+(yr/6)+int(y3_nudge)
    ...
    for i in range(0, 3) :
        for j in range(0, 5) :
            ...
            restRad = int(rad50*eyesy.knob3)+2
            color = eyesy.color_picker_lfo(eyesy.knob4, 50)
            if (i%2) == 1 :
                x4 = j*(xr/5)+(xr/10)+int(x4_nudge)
            if (j%2) == 1 :
                y4 = i*(yr/3)+(yr/6)+int(y4_nudge)
